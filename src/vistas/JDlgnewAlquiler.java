 ...
 * @author cahb2
 */
public class JDlgnewAlquiler extends javax.swing.JDialog {

    /**
     * Creates new form JDlgAlquiler
     */
    public JDlgnewAlquiler(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/alquileres8.png"))); // NOI18N
        ...
        lblTituloUsuario2.setText("Información Alquiler ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgnewAlquiler.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgnewAlquiler dialog = new JDlgnewAlquiler(new javax.swing.JFrame(), true);
